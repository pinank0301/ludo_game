...
class Ludo:
    ...
    def take_initial_control(self):
        ...
        top.iconbitmap("C:/Users/pinan/Desktop/WebVision/Ludo-Game-with-Sam-main/Ludo-Game-with-Sam-main/Images/ludo.ico")
...
if __name__ == '__main__':
    ...
    window.title("Play Ludo with WebVision")
    window.iconbitmap("C:/Users/pinan/Desktop/WebVision/Ludo-Game-with-Sam-main/Ludo-Game-with-Sam-main/Images/ludo.ico")
    block_six_side = ImageTk.PhotoImage(Image.open("C:/Users/pinan/Desktop/WebVision/Ludo-Game-with-Sam-main/Ludo-Game-with-Sam-main/Images/6_block.png").resize((33, 33), Image.Resampling.LANCZOS))
    block_five_side = ImageTk.PhotoImage(Image.open("C:/Users/pinan/Desktop/WebVision/Ludo-Game-with-Sam-main/Ludo-Game-with-Sam-main/Images/5_block.png").resize((33, 33), Image.Resampling.LANCZOS))
    block_four_side = ImageTk.PhotoImage(Image.open("C:/Users/pinan/Desktop/WebVision/Ludo-Game-with-Sam-main/Ludo-Game-with-Sam-main/Images/4_block.png").resize((33, 33), Image.Resampling.LANCZOS))
    block_three_side = ImageTk.PhotoImage(Image.open("C:/Users/pinan/Desktop/WebVision/Ludo-Game-with-Sam-main/Ludo-Game-with-Sam-main/Images/3_block.png").resize((33, 33), Image.Resampling.LANCZOS))
    block_two_side = ImageTk.PhotoImage(Image.open("C:/Users/pinan/Desktop/WebVision/Ludo-Game-with-Sam-main/Ludo-Game-with-Sam-main/Images/2_block.png").resize((33, 33), Image.Resampling.LANCZOS))
    block_one_side = ImageTk.PhotoImage(Image.open("C:/Users/pinan/Desktop/WebVision/Ludo-Game-with-Sam-main/Ludo-Game-with-Sam-main/Images/1_block.png").resize((33, 33), Image.Resampling.LANCZOS))
